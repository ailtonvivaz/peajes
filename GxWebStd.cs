/*
       ...
       Generated on: 1/26/2015 11:14:53.78
...
namespace GeneXus.Programs {
   public class GxWebStd
   {
                                              ...
                                              String sCallerPgm )
      {
         ...
         if ( ( nRTEnabled != 0 ) || ( nEnabled != 0 ) )
         {
            ...
            else
            {
               ...
               context.WriteHtmlText( "\"") ;
               if ( ! String.IsNullOrEmpty(StringUtil.RTrim( sStep)) && ( ( StringUtil.StrCmp(sType, "number") == 0 ) || ( StringUtil.StrCmp(sType, "range") == 0 ) ) )
               {
            ...
            if ( ! String.IsNullOrEmpty(StringUtil.RTrim( sPlaceholder)) )
            {
               ...
               context.SendWebValue( sPlaceholder) ;
               context.WriteHtmlText( "\"") ;
            }
            ...
            if ( ( StringUtil.StrCmp(sType, "date") != 0 ) && ( StringUtil.StrCmp(sType, "datetime") != 0 ) && ( StringUtil.StrCmp(sType, "datetime-local") != 0 ) )
            {
                                        ...
                                        String sCallerPgm )
      {
         ...
         context.WriteHtmlText( "<table border=\"0\" data-cellpadding=\"0\" data-cellspacing=\"0\" style=\"") ;
         ...
         if ( nDisplay == 0 )
         {
            ...
            context.SendWebValue( sStyleString) ;
         ...
         {
            GxWebStd.gx_hidden_field( context, sInternalName, sValue);
         }
                                         ...
                                         String sCallerPgm )
      {
         ...
         if ( StringUtil.Len( sAccesskey) != 0 )
         {
            ...
            context.SendWebValue( sAccesskey) ;
            context.WriteHtmlText( "\"") ;
         }
         GxWebStd.ClassAttribute( context, sClassString);
         GxWebStd.StyleAttribute( context, sStyleString);
      ...
      static public void gx_combobox_ctrl( IGxContext context ,
                                           ...
                                           String sCallerPgm )
      {
         gx_combobox_ctrl1( context, cmbCObjCtrl, sCtrlName, sValue, nRows, sUserOnClickCode, nJScriptCode, sEventName, sType, sTooltipText, nVisible, nEnabled, nRTEnabled, nFormat, nWidth, nWidthUnit, nHeight, nHeightUnit, sStyleString, sClassString, sColumnClassString, sTags, sFormatedValue, true, sCallerPgm) ;
      }
      ...
      static public void gx_listbox_ctrl( IGxContext context ,
                                          ...
                                          String sCallerPgm )
      {
         gx_listbox_ctrl1( context, lstLObjCtrl, sCtrlName, sValue, nRows, sUserOnClickCode, nJScriptCode, sEventName, sType, sTooltipText, nVisible, nEnabled, nRTEnabled, nFormat, nWidth, nWidthUnit, nHeight, nHeightUnit, sStyleString, sClassString, sColumnClassString, sTags, sFormatedValue, true, sCallerPgm) ;
      }
                                    ...
                                    String sCallerPgm )
      {
         ...
         else
         {
            ...
            {
               context.WriteHtmlText( " alt=\"") ;
               context.SendWebValue( sAlternateText) ;
               context.WriteHtmlText( "\"") ;
            }
            context.WriteHtmlText( " src=\"") ;
                                             ...
                                             String sCallerPgm )
      {
         ...
         else if ( ! String.IsNullOrEmpty(StringUtil.RTrim( sTooltipText)) )
         {
            context.SendWebValue( sTooltipText) ;
         }
         else
                                                   ...
                                                   String sCallerPgm )
      {
         ...
         GxWebStd.gx_single_line_edit( context, sInternalName+"_GXI", sURL, sURL, sInputTags, sEventName, "", "", sTooltipText, "", sUserOnClickCode, 0, "field "+sClassString, sStyleString, "", "", 1, 1, 1, "text", "", nWidth, nWidthUnit, nHeight, nHeightUnit, 254, 0, 2, 0, 1, 1, 0, true, "", sAlign, sCallerPgm);
            ...
            else
            {
               if ( String.IsNullOrEmpty(StringUtil.RTrim( context.GetReferer( ))) || context.IsLocalStorageSupported( ) )
               {
                  ...
                  else
                  {
                     ...
                     {
                        context.WriteHtmlText( "gx.evt.clinav = true;") ;
                     }
                     context.WriteHtmlText( "gx.evt.execLoad=false;gx.fn.closeWindow('") ;
                                          ...
                                          GXRadio radrMetaequiv )
      {
         ...
         if ( nContentType == 0 )
         {
            ...
            context.WriteHtmlTextNl( "<html lang=\""+context.GetLanguageProperty( "culture")+"\""+sHtmlStyle+">") ;
                                           ...
                                           String sScroll )
      {
         ...
         context.WriteHtmlText( " width=\""+StringUtil.LTrim( StringUtil.Str( (decimal)(nWidth), 4, 0))+sWidthUnit+"\"") ;
         context.WriteHtmlText( " height=\""+StringUtil.LTrim( StringUtil.Str( (decimal)(nHeight), 4, 0))+sHeightUnit+"\"") ;
         context.WriteHtmlText( " frameborder=\""+StringUtil.LTrim( StringUtil.Str( (decimal)(nBorderStyle), 4, 0))+"\""+" align=\""+sAlign+"\""+" title=\""+sTooltipText+"\""+" style=\""+sStyleString+"\""+" scrolling=\""+sScroll+"\""+"></IFRAME>") ;
      }
      ...
      /*  */
      static public void gx_hidden_field_wml( IGxContext context ,
                                              String sCtrlName ,
                                              String sValue )
      {
         context.httpAjaxContext.ajax_rsp_assign_hidden(sCtrlName, sValue);
      ...
      static public void gx_boolean_hidden_field_wml( IGxContext context ,
                                                      String sCtrlName ,
                                                      bool bValue )
      {
         context.httpAjaxContext.ajax_rsp_assign_boolean_hidden(sCtrlName, bValue);
      ...
      static public void gx_single_line_edit1_wml( IGxContext context ,
                                                   String sCtrlName ,
                                                   String sValue ,
                                                   String sFormatedValue ,
                                                   String sTags ,
                                                   ...
                                                   String sCallerPgm )
      {
         gx_single_line_edit_wml( context, sCtrlName, sValue, sFormatedValue, sTags, sEventName, sLinkURL, sLinkTarget, sTooltipText, sPlaceholder, sUserOnClickCode, nJScriptCode, sClassString, sStyleString, sROClassString, sColumnClassString, nVisible, nEnabled, nRTEnabled, sType, sStep, nWidth, nWidthUnit, nHeight, nHeightUnit, nLength, nIsPassword, nFormat, nParentId, bHasTheme, nAutoComplete, nAutoCorrection, bSendHidden, sDomainType, "", sCallerPgm) ;
      }

      static public void gx_single_line_edit_wml( IGxContext context ,
                                                  String sCtrlName ,
                                                  String sValue ,
                                                  String sFormatedValue ,
                                                  String sTags ,
                                                  ...
                                                  String sCallerPgm )
      {
         ...
         if ( ( nRTEnabled != 0 ) || ( nEnabled != 0 ) )
         {
            ...
            if ( nAutoComplete == 0 )
            {
               GxWebStd.gx_ctrl_attribute_wml( context, sCtrlName, "autocomplete", "off", false);
            }
         }
         if ( nEnabled == 0 )
         {
            ...
            if ( nFormat != 2 )
            {
               ...
               GxWebStd.gx_start_js_anchor_wml( context, sEventJsCode, sUserOnClickCode, sLinkURL, sLinkTarget);
            }
            if ( nIsPassword == 0 )
            {
               if ( nFormat == 0 )
            ...
            if ( nFormat != 2 )
            {
               GxWebStd.gx_end_js_anchor_wml( context, sEventJsCode, sUserOnClickCode, sLinkURL);
            }
         }
      }

      static public void gx_link_start_wml( IGxContext context ,
                                            String sLinkURL ,
                                            String sTargetWnd )
      {
         if ( StringUtil.StrCmp("", StringUtil.RTrim( sLinkURL)) != 0 )
      ...
      static public void gx_link_end_wml( IGxContext context ,
                                          String sLinkURL )
      {
         if ( StringUtil.StrCmp("", StringUtil.RTrim( sLinkURL)) != 0 )
         {
      ...
      static public void gx_blob_field_wml( IGxContext context ,
                                            String sInternalName ,
                                            String sValue ,
                                            String sURL ,
                                            String sContenttype ,
      ...
      static public void gx_button_ctrl_wml( IGxContext context ,
                                             String sCtrlName ,
                                             String sJsCode ,
                                             String sCaption ,
                                             String sUserOnClickCode ,
                                             ...
                                             String sCallerPgm )
      {
         ...
         sEventJsCode = sJsCode + sEventJsCode;
         GxWebStd.gx_on_js_event_wml( context, "onclick", sEventJsCode);
         context.WriteHtmlText( " ") ;
         context.WriteHtmlText( sTags) ;
         context.WriteHtmlText( GXUtil.HtmlEndTag( HTMLElement.INPUT)) ;
         GxWebStd.gx_ctrl_attribute_wml( context, sCtrlName, "jsevent", sUserOnClickCode, false);
         if ( StringUtil.StrCmp(sBorderStyle, "rounded") == 0 )
         {
            context.WriteHtmlText( "</span></span></span></span>") ;
         }
      ...
      static public void gx_on_js_event_wml( IGxContext context ,
                                             String sEventName ,
                                             String sEventJsCode )
      {
         context.WriteHtmlText( " ") ;
      ...
      static public void gx_ctrl_attribute_wml( IGxContext context ,
                                                String sControlName ,
                                                String sAttName ,
                                                String sAttValue ,
                                                bool bCustomEvent )
      ...
      static public void gx_msg_list_wml( IGxContext context ,
                                          String sCtrlName ,
                                          int nDisplayMode ,
                                          String sStyleString ,
                                          String sClassString ,
      ...
      static public void gx_combobox_ctrl_wml( IGxContext context ,
                                               GXCombobox cmbCObjCtrl ,
                                               String sCtrlName ,
                                               String sValue ,
                                               int nRows ,
                                               ...
                                               String sCallerPgm )
      {
         gx_combobox_ctrl1_wml( context, cmbCObjCtrl, sCtrlName, sValue, nRows, sUserOnClickCode, nJScriptCode, sEventName, sType, sTooltipText, nVisible, nEnabled, nRTEnabled, nFormat, nWidth, nWidthUnit, nHeight, nHeightUnit, sStyleString, sClassString, sColumnClassString, sTags, sFormatedValue, true, sCallerPgm) ;
      }

      static public void gx_combobox_ctrl1_wml( IGxContext context ,
                                                GXCombobox cmbCObjCtrl ,
                                                String sCtrlName ,
                                                String sValue ,
                                                int nRows ,
                                                ...
                                                String sCallerPgm )
      {
         ...
         if ( ( nEnabled != 0 ) || ( nRTEnabled != 0 ) )
         {
            ...
            context.WriteHtmlTextNl( "</select>") ;
            GxWebStd.gx_ctrl_attribute_wml( context, sCtrlName, "jsevent", sUserOnClickCode, false);
            GxWebStd.gx_ctrl_attribute_wml( context, sCtrlName, "gxoch0", sEventJsCode, true);
         }
         if ( nEnabled == 0 )
         {
            if ( ( nRTEnabled == 0 ) && bSendHidden )
      ...
      static public void gx_listbox_ctrl_wml( IGxContext context ,
                                              GXListbox lstLObjCtrl ,
                                              String sCtrlName ,
                                              String sValue ,
                                              int nRows ,
                                              ...
                                              String sCallerPgm )
      {
         gx_listbox_ctrl1_wml( context, lstLObjCtrl, sCtrlName, sValue, nRows, sUserOnClickCode, nJScriptCode, sEventName, sType, sTooltipText, nVisible, nEnabled, nRTEnabled, nFormat, nWidth, nWidthUnit, nHeight, nHeightUnit, sStyleString, sClassString, sColumnClassString, sTags, sFormatedValue, true, sCallerPgm) ;
      }

      static public void gx_listbox_ctrl1_wml( IGxContext context ,
                                               GXListbox lstLObjCtrl ,
                                               String sCtrlName ,
                                               String sValue ,
                                               int nRows ,
      ...
      static public void gx_radio_ctrl_wml( IGxContext context ,
                                            GXRadio radRObjCtrl ,
                                            String sCtrlName ,
                                            String sValue ,
                                            String sTooltipText ,
      ...
      static public void gx_checkbox_ctrl_wml( IGxContext context ,
                                               String sCtrlName ,
                                               String sValue ,
                                               String sTooltipText ,
                                               int nVisible ,
      ...
      static public void gx_bitmap_wml( IGxContext context ,
                                        String sInternalName ,
                                        String sImageURL ,
                                        String sLinkURL ,
                                        String sLinkTarget ,
                                        ...
                                        String sCallerPgm )
      {
         ...
         if ( ( nReadOnly == 1 ) || ( nEnabled == 0 ) )
         {
            GxWebStd.gx_bitmap_readonly_wml( context, sInternalName, sImageURL, sLinkURL, sLinkTarget, sAccesskey, sThemeName, nVisible, nEnabled, sAlternateText, sTooltipText, nBorderWidth, nAutoresize, nWidth, nWidthUnit, nHeight, nHeightUnit, nVerticalSpace, nHorizontalSpace, nJScriptCode, sUserOnClickCode, sEventName, sStyleString, ClassHTML, sColumnClassString, sAlign, sImageTags, sUseMap, sJsDynCode, sCallerPgm);
         }
         else
         {
            GxWebStd.gx_multimedia_upload_start_wml( context, sInternalName, nVisible, nWidth, sStyleString);
            context.WriteHtmlText( "<a class=\"action change-action\" gxfocusable=\"1\" href=\"\"") ;
            context.WriteHtmlText( sInputTags) ;
            context.WriteHtmlText( ">") ;
            context.WriteHtmlText( context.GetMessage( "GXM_multimediachange", "")) ;
            ...
            context.WriteHtmlText( "</span>") ;
            context.WriteHtmlText( "</a>") ;
            GxWebStd.gx_multimedia_upload_end_wml( context, sInternalName, sImageURL, sTooltipText, nWidth, nWidthUnit, nHeight, nHeightUnit, sUserOnClickCode, sEventName, sStyleString, sClassString, "", sAlign, sInputTags, nReadOnly, bIsBlob, "image/*", sCallerPgm);
         }
      }

      static public void gx_bitmap_readonly_wml( IGxContext context ,
                                                 String sInternalName ,
                                                 String sImageURL ,
                                                 String sLinkURL ,
                                                 String sLinkTarget ,
                                                 ...
                                                 String sCallerPgm )
      {
         ...
         if ( StringUtil.StrCmp(sEventJsCode, "") != 0 )
         {
            ...
            context.SendWebValue( sInternalName) ;
            context.WriteHtmlText( "\"") ;
            GxWebStd.gx_on_js_event_wml( context, "onclick", sEventJsCode+"return false;");
            if ( nEnabled == 0 )
            {
               context.WriteHtmlText( " disabled=\"disabled\" ") ;
            }
         ...
         if ( StringUtil.StrCmp(sEventJsCode, "") != 0 )
         {
            GxWebStd.gx_ctrl_attribute_wml( context, sInternalName, "jsevent", sUserOnClickCode, false);
         }
         if ( ( nEnabled != 0 ) && ( StringUtil.StrCmp(sLinkURL, "") != 0 ) && ( StringUtil.StrCmp(sEventJsCode, "") == 0 ) )
         {
            GxWebStd.gx_end_js_anchor_wml( context, sEventJsCode, sUserOnClickCode, sLinkURL);
      ...
      static public void gx_multimedia_upload_start_wml( IGxContext context ,
                                                         String sInternalName ,
                                                         int nVisible ,
                                                         int nWidth ,
                                                         String sStyleString )
      ...
      static public void gx_multimedia_upload_end_wml( IGxContext context ,
                                                       String sInternalName ,
                                                       String sMultimediaURL ,
                                                       String sTooltipText ,
                                                       int nWidth ,
                                                       ...
                                                       String sCallerPgm )
      {
         ...
         GxWebStd.gx_single_line_edit_wml( context, sInternalName+"_GXI", sURL, sURL, sInputTags, sEventName, "", "", sTooltipText, "", sUserOnClickCode, 0, "field "+sClassString, sStyleString, "", "", 1, 1, 1, "text", "", nWidth, nWidthUnit, nHeight, nHeightUnit, 254, 0, 2, 0, 1, 1, 0, true, "", sAlign, sCallerPgm);
         context.WriteHtmlText( "<input type=\"file\" class=\"field ") ;
         context.SendWebValue( sClassString) ;
         context.WriteHtmlText( "\"") ;
         context.WriteHtmlText( " id=\"") ;
      ...
      static public void gx_video_wml( IGxContext context ,
                                       String sInternalName ,
                                       String sMultimediaURL ,
                                       int nDisplay ,
                                       int nVisible ,
                                       ...
                                       String sCallerPgm )
      {
         ...
         if ( ( nReadOnly == 0 ) && ( nEnabled == 1 ) )
         {
            GxWebStd.gx_multimedia_upload_end_wml( context, sInternalName, sMultimediaURL, "", nWidth, nWidthUnit, nHeight, nHeightUnit, sUserOnClickCode, sEventName, sStyleString, sClassString, "", "", sInputTags, nReadOnly, bIsBlob, "video/*", sCallerPgm);
         }
      }

      static public void gx_audio_wml( IGxContext context ,
                                       String sInternalName ,
                                       String sMultimediaURL ,
                                       int nDisplay ,
                                       int nVisible ,
                                       ...
                                       String sCallerPgm )
      {
         ...
         if ( ( nReadOnly == 0 ) && ( nEnabled == 1 ) )
         {
            GxWebStd.gx_multimedia_upload_end_wml( context, sInternalName, sMultimediaURL, "", nWidth, nWidthUnit, nHeight, nHeightUnit, sUserOnClickCode, sEventName, sStyleString, sClassString, "", "", sInputTags, nReadOnly, bIsBlob, "audio/*", sCallerPgm);
         }
      }

      static public void gx_label_ctrl_wml( IGxContext context ,
                                            String sInternalName ,
                                            String sCaption ,
                                            String sLinkURL ,
                                            String sLinkTarget ,
                                            ...
                                            String sCallerPgm )
      {
         ...
         if ( ( nFormat != 0 ) && ( nFormat != 2 ) )
         {
            GxWebStd.gx_ctrl_attribute_wml( context, sInternalName, "gxformat", StringUtil.Str( (decimal)(nFormat), 1, 0), false);
         }
         if ( ( nFormat == 1 ) && ( ! String.IsNullOrEmpty(StringUtil.RTrim( sEventJsCode)) || ! String.IsNullOrEmpty(StringUtil.RTrim( sUserOnClickCode)) || ! String.IsNullOrEmpty(StringUtil.RTrim( sLinkURL)) ) )
         {
            GxWebStd.gx_ctrl_attribute_wml( context, sInternalName, "gxlink", "1", false);
         }
      }

      static public void gx_start_js_anchor_wml( IGxContext context ,
                                                 String sGXOnClickCode ,
                                                 String sUserOnClickCode ,
                                                 String sLinkURL ,
                                                 String sLinkTarget )
      {
         ...
         else
         {
            ...
            {
               GxWebStd.gx_link_start_wml( context, sLinkURL, sLinkTarget);
            }
         }
      }

      static public void gx_end_js_anchor_wml( IGxContext context ,
                                               String sGXOnClickCode ,
                                               String sUserOnClickCode ,
                                               String sLinkURL )
      {
         ...
         {
            GxWebStd.gx_link_end_wml( context, sLinkURL);
         }
      }

      static public bool gx_redirect_wml( IGxContext context )
      {
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) )
         {
            context.Redirect( context.wjLoc );
      ...
      static public void gx_table_start_wml( IGxContext context ,
                                             String sCtrlName ,
                                             String sHTMLid ,
                                             String sHTMLTags ,
                                             String sClassString ,
      ...
      static public void gx_html_headers_wml( IGxContext context ,
                                              int nContentType ,
                                              String sCacheCtrl ,
                                              String sCacheExp ,
                                              GXRadio radrMeta ,
                                              GXRadio radrMetaequiv )
      {
         ...
         bool addContentType ;
         String sHtmlStyle ;
         GxWebStd.set_html_headers_wml( context, nContentType, sCacheCtrl, sCacheExp);
         if ( nContentType == 0 )
         {
            if ( ! context.isPopUpObject( ) )
            {
      ...
      static public void set_html_headers_wml( IGxContext context ,
                                               int nContentType ,
                                               String sCacheCtrl ,
                                               String sCacheExp )
      {
      ...
      static public void gx_html_textarea_wml( IGxContext context ,
                                               String sCtrlName ,
                                               String sValue ,
                                               String sLinkURL ,
                                               String sTags ,
                                               ...
                                               String sCallerPgm )
      {
         ...
         if ( ( nRTEnabled != 0 ) || ( nEnabled != 0 ) )
         {
            ...
            context.SendWebValue( sValue) ;
            context.WriteHtmlTextNl( "</textarea>") ;
            GxWebStd.gx_ctrl_attribute_wml( context, sCtrlName, "maxlength", sLength, false);
         }
         if ( nEnabled == 0 )
         {
            sStyleString = ((nVisible==0) ? ";display:none;" : "");
      ...
      static public void gx_geolocation_wml( IGxContext context ,
                                             String sCtrlName ,
                                             String sValue ,
                                             String sFormatedValue ,
                                             String sTags ,
                                             ...
                                             String sAlign )
      {
         GxWebStd.gx_single_line_edit_wml( context, sCtrlName, sValue, sFormatedValue, sTags, sEventName, sLinkURL, sLinkTarget, sTooltipText, sPlaceholder, sUserOnClickCode, nJScriptCode, sClassString, sStyleString, sROClassString, sColumnClassString, nVisible, nEnabled, nRTEnabled, sType, sStep, nWidth, nWidthUnit, nHeight, nHeightUnit, nLength, nIsPassword, nFormat, nParentId, bHasTheme, nAutoComplete, nAutoCorrection, bSendHidden, sDomainType, "", "");
         if ( ( nRTEnabled != 0 ) || ( nEnabled != 0 ) )
         {
            GxWebStd.gx_bitmap_readonly_wml( context, sCtrlName+"_geoLocMe", context.convertURL( "locateMe"), "", "", "", "", nVisible, 1, context.GetMessage( "GXM_locatemeoption", ""), context.GetMessage( "GXM_locatemeoption", ""), 0, 0, 0, nWidthUnit, 0, nHeightUnit, 0, 0, 4, sUserOnClickCode, sEventName, sStyleString, "GeoLocOption", "", "", "", "", "gx.geolocation.getMyPosition(this);", "");
         }
      }

      static public void gx_group_start_wml( IGxContext context ,
                                             String sInternalName ,
                                             String sCaption ,
                                             int nVisible ,
                                             int nWidth ,
      ...
      static public void gx_div_start_wml( IGxContext context ,
                                           String sInternalName ,
                                           int nVisible ,
                                           int nWidth ,
                                           String sWidthUnit ,
      ...
      static public void gx_embedded_page_wml( IGxContext context ,
                                               String sInternalName ,
                                               String sSrc ,
                                               int nVisible ,
                                               int nWidth ,
