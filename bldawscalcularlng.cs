...
using System.IO;
public class bldawscalcularlng : GxBaseBuilder
{
   string cs_path = "." ;
   public bldawscalcularlng( ) : base()
   {
   }
   ...
   {
      bldawscalcularlng x = new bldawscalcularlng() ;
      x.SetMainSourceFile( "awscalcularlng.cs");
