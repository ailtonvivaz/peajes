/*
       ...
       Generated on: 1/26/2015 11:14:55.13
   ...
   public class recentlinks : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( context.GetMessage( "Recent Links web component", "")) ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?201512611145515");
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" class=\"Form\" novalidate action=\""+formatLink("recentlinks.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV6FormCaption)) + "," + UrlEncode(StringUtil.RTrim(AV7FormPgmName))+"\">") ;
      ...
      protected void RenderHtmlCloseForm022( )
      {
         ...
         /* Send saved values. */
         GxWebStd.gx_hidden_field( context, sPrefix+"nRC_GXsfl_7", StringUtil.LTrim( StringUtil.NToC( (decimal)(nRC_GXsfl_7), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
         ...
         {
            context.AddJavascriptSource("recentlinks.js", "?201512611145516");
         }
      ...
      {
         return context.GetMessage( "Recent Links web component", "") ;
      }
      ...
      protected void START022( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", context.GetMessage( "Recent Links web component", ""), 0) ;
            }
            context.wjLoc = "";
      ...
      protected void gxnrLinks_newrow( short nRC_GXsfl_7 ,
                                       short nGXsfl_7_idx ,
                                       String sGXsfl_7_idx ,
                                       String sPrefix )
      {
      ...
      protected void STRUP020( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            /* Read saved values. */
            nRC_GXsfl_7 = (short)(context.localUtil.CToN( cgiGet( sPrefix+"nRC_GXsfl_7"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")));
      ...
      protected void wb_table1_2_022( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblRecenttext_Internalname, context.GetMessage( "Recents: ", ""), "", "", lblRecenttext_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "RecentLink", 0, "", 1, 1, 0, "HLP_RecentLinks.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /*  Grid Control  */
            ...
            {
               context.WriteHtmlText( "<div id=\""+sPrefix+"LinksContainer"+"DivS\" gxgridid=\"7\">") ;
               sStyleString = "";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?201512611145525");
            idxLst = (int)(idxLst+1);
         }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("recentlinks.js", "?201512611145525");
         }
      ...
      protected void sendrow_72( )
      {
         ...
         LinksRow.AddColumnProperties("cell", -1, isAjaxCallMode( ), new Object[] {(String)"",(String)""+" style=\"width:37px\""});
         /* Text block */
         ...
         LinksRow.AddColumnProperties("cell", -1, isAjaxCallMode( ), new Object[] {(String)"",(String)""+" style=\"width:4px\""});
         /* Text block */
