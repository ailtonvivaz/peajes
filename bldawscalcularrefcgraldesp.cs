...
using System.IO;
public class bldawscalcularrefcgraldesp : GxBaseBuilder
{
   string cs_path = "." ;
   public bldawscalcularrefcgraldesp( ) : base()
   {
   }
   ...
   {
      bldawscalcularrefcgraldesp x = new bldawscalcularrefcgraldesp() ;
      x.SetMainSourceFile( "awscalcularrefcgraldesp.cs");
