/*
       ...
       Generated on: 1/20/2015 7:38:21.65
...
namespace GeneXus.Programs {
   public class viewlpg : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public viewlpg( )
      {
      ...
      public viewlpg( IGxContext context )
      {
      ...
      public void execute( short aP0_LPGID ,
                           String aP1_TabCode )
      {
         this.AV13LPGID = aP0_LPGID;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled )
            {
               AV13LPGID = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13LPGID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV13LPGID), 4, 0)));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20151207382167");
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewlpg.aspx") + "?" + UrlEncode("" +AV13LPGID) + "," + UrlEncode(StringUtil.RTrim(AV7TabCode))+"\">") ;
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vLPGID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV13LPGID), 4, 0, context.GetLanguageProperty( "decimal_point"), "")));
      ...
      {
         return formatLink("viewlpg.aspx") + "?" + UrlEncode("" +AV13LPGID) + "," + UrlEncode(StringUtil.RTrim(AV7TabCode)) ;
      }
      ...
      {
         return context.GetMessage( "View LPG", "") ;
      }
      ...
      protected void WB0R0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, context.GetMessage( "LPG Information", ""), "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_ViewLPG.htm");
            context.WriteHtmlText( "</div>") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-6 WWActionsCell", " "+"id"+" ");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, context.GetMessage( "Work With LPGS", ""), lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlock", 0, "", lblViewall_Visible, 1, 0, "HLP_ViewLPG.htm");
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "</div>") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lbllbl12_Internalname, context.GetMessage( "Banda M3", ""), "", "", lbllbl12_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_ViewLPG.htm");
            context.WriteHtmlText( "</label>") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtLPGBandaM3_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A14LPGBandaM3), 12, 0, context.GetLanguageProperty( "decimal_point"), "")), ((edtLPGBandaM3_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A14LPGBandaM3), "ZZZZZZZZZZZ9")) : context.localUtil.Format( (decimal)(A14LPGBandaM3), "ZZZZZZZZZZZ9")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtLPGBandaM3_Jsonclick, 0, "ReadonlyAttribute", "", "", "", 1, edtLPGBandaM3_Enabled, 0, "text", "", 12, "chr", 1, "row", 12, 0, 0, 0, 1, 1, 0, true, "", "right", "HLP_ViewLPG.htm");
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "</div>") ;
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, context.GetMessage( "General", ""), "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ViewLPG.htm");
            /* Div Control */
      ...
      protected void START0R2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "View LPG", ""), 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF0R2( )
      {
         ...
         {
            /* Using cursor H000R2 */
            pr_default.execute(0, new Object[] {AV13LPGID});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A13LPGID = H000R2_A13LPGID[0];
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A13LPGID", StringUtil.LTrim( StringUtil.Str( (decimal)(A13LPGID), 4, 0)));
               A14LPGBandaM3 = H000R2_A14LPGBandaM3[0];
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A14LPGBandaM3", StringUtil.LTrim( StringUtil.Str( (decimal)(A14LPGBandaM3), 12, 0)));
               /* Execute user event: E120R2 */
               E120R2 ();
      ...
      protected void STRUP0R0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            A14LPGBandaM3 = (long)(context.localUtil.CToN( cgiGet( edtLPGBandaM3_Internalname), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")));
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A14LPGBandaM3", StringUtil.LTrim( StringUtil.Str( (decimal)(A14LPGBandaM3), 12, 0)));
            /* Read saved values. */
            AV13LPGID = (short)(context.localUtil.CToN( cgiGet( "vLPGID"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")));
      ...
      protected void E110R2( )
      {
         ...
         /* Using cursor H000R3 */
         pr_default.execute(1, new Object[] {AV13LPGID});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A13LPGID = H000R3_A13LPGID[0];
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A13LPGID", StringUtil.LTrim( StringUtil.Str( (decimal)(A13LPGID), 4, 0)));
            A14LPGBandaM3 = H000R3_A14LPGBandaM3[0];
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A14LPGBandaM3", StringUtil.LTrim( StringUtil.Str( (decimal)(A14LPGBandaM3), 12, 0)));
            AV17GXLvl6 = 1;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV17GXLvl6", StringUtil.Str( (decimal)(AV17GXLvl6), 1, 0));
            Form.Caption = StringUtil.Str( (decimal)(A14LPGBandaM3), 12, 0);
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, "FORM", "Caption", Form.Caption);
            lblViewall_Link = formatLink("wwlpg.aspx") ;
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "LPGGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "lpggeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "LPGGeneral";
               WebComp_Generalwc_Component = "LPGGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0025",(String)"",(short)AV13LPGID});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV13LPGID = Convert.ToInt16(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13LPGID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV13LPGID), 4, 0)));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20151207382181");
            idxLst = (int)(idxLst+1);
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewlpg.js", "?20151207382181");
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "");
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "");
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "");
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "");
      ...
      protected void init_default_properties( )
      {
         ...
         lbllbl12_Internalname = "LBL12";
         edtLPGBandaM3_Internalname = "LPGBANDAM3";
         edtLPGBandaM3_Internalname = "LPGBANDAM3";
         div_Internalname = "";
         div_Internalname = "";
      ...
      public override void initialize_properties( )
      {
         ...
         edtLPGBandaM3_Jsonclick = "";
         edtLPGBandaM3_Enabled = 0;
         lblViewall_Link = "";
         ...
         Form.Caption = context.GetMessage( "View LPG", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      public override void initialize( )
      {
         ...
         AV16Pgmname = "";
         scmdbuf = "";
         H000R2_A13LPGID = new short[1] ;
         H000R2_A14LPGBandaM3 = new long[1] ;
         H000R3_A13LPGID = new short[1] ;
         H000R3_A14LPGBandaM3 = new long[1] ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewlpg__default(),
            new Object[][] {
                new Object[] {
               H000R2_A13LPGID, H000R2_A14LPGBandaM3
               }
               , new Object[] {
               H000R3_A13LPGID, H000R3_A14LPGBandaM3
               }
            }
         );
      ...
      private short AV13LPGID ;
      private short wcpOAV13LPGID ;
      ...
      private int edtLPGBandaM3_Enabled ;
      private int idxLst ;
      ...
      private String edtLPGBandaM3_Internalname ;
      private String edtLPGBandaM3_Jsonclick ;
      ...
      private short[] H000R2_A13LPGID ;
      private long[] H000R2_A14LPGBandaM3 ;
      private short[] H000R3_A13LPGID ;
      private long[] H000R3_A14LPGBandaM3 ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewlpg__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV13LPGID",SqlDbType.SmallInt,4,0}
          } ;
          Object[] prmH000R3 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H000R2", "SELECT [LPGID], [LPGBandaM3] FROM [LPG] WITH (NOLOCK) WHERE [LPGID] = @AV13LPGID ORDER BY [LPGID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000R2,1,0,true,true )
             ,new CursorDef("H000R3", "SELECT [LPGID], [LPGBandaM3] FROM [LPG] WITH (NOLOCK) WHERE [LPGID] = @AV13LPGID ORDER BY [LPGID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000R3,1,0,false,true )
          };
       }
    }
