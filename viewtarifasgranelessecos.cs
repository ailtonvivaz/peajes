/*
       ...
       Generated on: 1/20/2015 7:38:22.43
...
namespace GeneXus.Programs {
   public class viewtarifasgranelessecos : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public viewtarifasgranelessecos( )
      {
      ...
      public viewtarifasgranelessecos( IGxContext context )
      {
      ...
      public void execute( long aP0_TarifasGranelesSecosCodPeaje ,
                           String aP1_TabCode )
      {
         this.AV13TarifasGranelesSecosCodPeaje = aP0_TarifasGranelesSecosCodPeaje;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled )
            {
               AV13TarifasGranelesSecosCodPeaje = (long)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13TarifasGranelesSecosCodPeaje", StringUtil.LTrim( StringUtil.Str( (decimal)(AV13TarifasGranelesSecosCodPeaje), 10, 0)));
      ...
      {
         return formatLink("viewtarifasgranelessecos.aspx") + "?" + UrlEncode("" +AV13TarifasGranelesSecosCodPeaje) + "," + UrlEncode(StringUtil.RTrim(AV7TabCode)) ;
      }

      public override String GetPgmname( )
      {
         return "viewtarifasgranelessecos" ;
      }

      public override String GetPgmdesc( )
      {
         return context.GetMessage( "View Tarifas Graneles Secos", "") ;
      }
      ...
      protected void START1G2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "View Tarifas Graneles Secos", ""), 0) ;
         }
         context.wjLoc = "";
      ...
      protected void STRUP1G0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            /* Read saved values. */
            AV13TarifasGranelesSecosCodPeaje = (long)(context.localUtil.CToN( cgiGet( "vTARIFASGRANELESSECOSCODPEAJE"), context.GetLanguageProperty( "decimal_point"), context.GetLanguageProperty( "thousand_sep")));
      ...
      protected void E111G2( )
      {
         ...
         /* Using cursor H001G2 */
         pr_default.execute(0, new Object[] {AV13TarifasGranelesSecosCodPeaje});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A51TarifasGranelesSecosCodPeaje = H001G2_A51TarifasGranelesSecosCodPeaje[0];
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A51TarifasGranelesSecosCodPeaje", StringUtil.LTrim( StringUtil.Str( (decimal)(A51TarifasGranelesSecosCodPeaje), 10, 0)));
            AV17GXLvl6 = 1;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV17GXLvl6", StringUtil.Str( (decimal)(AV17GXLvl6), 1, 0));
            Form.Caption = context.GetMessage( "Tarifas Graneles Secos", "");
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, "FORM", "Caption", Form.Caption);
            lblViewall_Link = formatLink("wwtarifasgranelessecos.aspx") ;
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV13TarifasGranelesSecosCodPeaje = Convert.ToInt64(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13TarifasGranelesSecosCodPeaje", StringUtil.LTrim( StringUtil.Str( (decimal)(AV13TarifasGranelesSecosCodPeaje), 10, 0)));
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewtarifasgranelessecos.js", "?20151207382255");
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "");
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "");
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "");
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "");
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "View Tarifas Graneles Secos", "");
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      public override void initialize( )
      {
         ...
         AV16Pgmname = "";
         scmdbuf = "";
         H001G2_A51TarifasGranelesSecosCodPeaje = new long[1] ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewtarifasgranelessecos__default(),
            new Object[][] {
                new Object[] {
               H001G2_A51TarifasGranelesSecosCodPeaje
               }
            }
         );
      ...
      private int idxLst ;
      private long AV13TarifasGranelesSecosCodPeaje ;
      private long wcpOAV13TarifasGranelesSecosCodPeaje ;
      ...
      private long[] H001G2_A51TarifasGranelesSecosCodPeaje ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewtarifasgranelessecos__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV13TarifasGranelesSecosCodPeaje",SqlDbType.Decimal,10,0}
          } ;
          def= new CursorDef[] {
              new CursorDef("H001G2", "SELECT [TarifasGranelesSecosCodPeaje] FROM [TarifasGranelesSecos] WITH (NOLOCK) WHERE [TarifasGranelesSecosCodPeaje] = @AV13TarifasGranelesSecosCodPeaje ORDER BY [TarifasGranelesSecosCodPeaje] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001G2,1,0,false,true )
          };
       }
    }
