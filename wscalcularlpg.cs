/*
               File: wscalcularlpg
        Description: Stub for wscalcularlpg
             Author: GeneXus C# Generator version 10_3_2-86442
       Generated on: 1/26/2015 11:14:58.41
...
namespace GeneXus.Programs {
   public class wscalcularlpg : GXProcedure
   {
      public wscalcularlpg( )
      {
      ...
      public wscalcularlpg( IGxContext context )
      {
      ...
      {
         this.AV2LPGBandaM3 = aP0_LPGBandaM3;
         this.AV3Resultado = "" ;
         initialize();
         executePrivate();
      ...
      public void executeSubmit( long aP0_LPGBandaM3 ,
                                 out String aP1_Resultado )
      {
         wscalcularlpg objwscalcularlpg;
         objwscalcularlpg = new wscalcularlpg();
         objwscalcularlpg.AV2LPGBandaM3 = aP0_LPGBandaM3;
         objwscalcularlpg.AV3Resultado = "" ;
         objwscalcularlpg.context.SetSubmitInitialConfig(context);
         objwscalcularlpg.initialize();
         ThreadPool.QueueUserWorkItem( new WaitCallback( executePrivateCatch ),objwscalcularlpg);
         aP1_Resultado=this.AV3Resultado;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((wscalcularlpg)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         SoapParm.AssignLocationProperties( context, "Awscalcularlpg", GXSoapHTTPClient);
         GXSoapHTTPClient.AddHeader("Content-type", "text/xml;charset=utf-8");
         GXSoapHTTPClient.AddHeader("SOAPAction", "CalcularPeajesaction/"+"AWSCALCULARLPG.Execute");
         ...
         GXSoapXMLWriter.WriteElement("Lpgbandam3", StringUtil.Trim( StringUtil.Str( (decimal)(AV2LPGBandaM3), 12, 0)));
         GXSoapXMLWriter.WriteAttribute("xmlns", "http://tempuri.org/");
         GXSoapXMLWriter.WriteEndElement();
         GXSoapXMLWriter.WriteEndElement();
         GXSoapXMLWriter.WriteEndElement();
         GXSoapXMLWriter.Close();
         GXSoapHTTPClient.Execute("POST", "awscalcularlpg.aspx");
         ...
         if ( currSoapErr != 0 )
         {
            oLocation = SoapParm.getlocation( context, "Awscalcularlpg");
