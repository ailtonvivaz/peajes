(function ($) {
	...
	new gx.plugdesign.Template({
		name: 'checkbox',
		selector: '.gx-attribute span:has(input[type="checkbox"])',
		template: '<div class="checkbox"><label>{{{outerHTML}}}</label></div>',
		outerHTML: true,
	...
	new gx.plugdesign.Template({
		...
		template: '<td><div class="radio"><label>{{{innerHTML}}}</label></div></td>',
		innerHTML: true,
		setContext: function (context, el) {
	...
	new gx.plugdesign.Template({
		...
		template: '<label class="radio-inline">{{{outerHTML}}}{{labelText}}</label>',
		outerHTML: true,
		setContext: function (context, el) {
