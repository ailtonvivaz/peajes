...
using System.IO;
public class bldawscalcularquimiqueros : GxBaseBuilder
{
   string cs_path = "." ;
   public bldawscalcularquimiqueros( ) : base()
   {
   }
   ...
   {
      bldawscalcularquimiqueros x = new bldawscalcularquimiqueros() ;
      x.SetMainSourceFile( "awscalcularquimiqueros.cs");
