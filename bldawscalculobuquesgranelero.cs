...
using System.IO;
public class bldawscalculobuquesgranelero : GxBaseBuilder
{
   string cs_path = "." ;
   public bldawscalculobuquesgranelero( ) : base()
   {
   }
   ...
   {
      bldawscalculobuquesgranelero x = new bldawscalculobuquesgranelero() ;
      x.SetMainSourceFile( "awscalculobuquesgranelero.cs");
