/*
               File: type_Sdtwsrest_services
        Description: wsrest_services
             Author: GeneXus C# Generator version 10_3_2-86442
       Generated on: 1/20/2015 7:41:53.63
...
namespace GeneXus.Programs {
   [Serializable]
   public class Sdtwsrest_services : GxUserType
   {
      public Sdtwsrest_services( )
      {
         initialize();
      }

      public Sdtwsrest_services( IGxContext context )
      {
