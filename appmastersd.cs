/*
       ...
       Generated on: 1/26/2015 11:15:2.60
...
namespace GeneXus.Programs {
   public class appmastersd : GXMasterPage, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlCloseForm0J2( )
      {
         ...
         context.AddJavascriptSource("appmastersd.js", "?20151261115261");
      ...
      protected void wb_table1_2_0J2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            context.WriteHtmlText( "<tr style=\"vertical-align:top\">") ;
      ...
      protected void wb_table2_5_0J2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table3_14_0J2( true) ;
         }
         else
         {
            wb_table3_14_0J2( false) ;
         }
         return  ;
      }

      protected void wb_table3_14_0J2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
            ...
            wb_table4_20_0J2( true) ;
         }
         else
         {
            wb_table4_20_0J2( false) ;
         }
         return  ;
      }

      protected void wb_table4_20_0J2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table5_23_0J2( true) ;
         }
         else
         {
            wb_table5_23_0J2( false) ;
         }
         return  ;
      }

      protected void wb_table5_23_0J2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
      ...
      protected void wb_table5_23_0J2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table5_23_0J2e( true) ;
         }
         else
         {
            wb_table5_23_0J2e( false) ;
         }
      }

      protected void wb_table4_20_0J2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_20_0J2e( true) ;
         }
         else
         {
            wb_table4_20_0J2e( false) ;
         }
      }

      protected void wb_table3_14_0J2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_14_0J2e( true) ;
         }
         else
         {
            wb_table3_14_0J2e( false) ;
         }
      }
      ...
      protected void wb_table2_5_0J2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            ClassString = "Image";
            StyleString = "";
            GxWebStd.gx_bitmap( context, imgImage1_Internalname, context.GetImagePath( "58259822-4ead-4fc4-a8e4-29b2e06d98ad", "", context.GetTheme( )), "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "", "", 1, false, false, "HLP_AppMasterSD.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "Image";
            StyleString = "";
            GxWebStd.gx_bitmap( context, imgImage2_Internalname, context.GetImagePath( "4a2815df-714d-4a1c-afc7-23440263a0a7", "", context.GetTheme( )), "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "", "", 1, false, false, "HLP_AppMasterSD.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
      ...
      {
         AddThemeStyleSheetFile("", context.GetTheme( )+".css", "?11145341");
         idxLst = 1;
         while ( idxLst <= (getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Count )
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?20151261115264");
            idxLst = (int)(idxLst+1);
         }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("appmastersd.js", "?20151261115264");
         }
