/*
        ...
        Description: Stub for wscalcularrefcgraldesp
             Author: GeneXus C# Generator version 10_3_2-86442
       Generated on: 1/26/2015 11:14:58.68
...
namespace GeneXus.Programs {
   public class wscalcularrefcgraldesp : GXProcedure
   {
      public wscalcularrefcgraldesp( )
      {
      ...
      public wscalcularrefcgraldesp( IGxContext context )
      {
      ...
      public void execute( long aP0_Tonelaje ,
                           ...
                           out short aP3_Resultado )
      {
         this.AV2Tonelaje = aP0_Tonelaje;
         this.AV3Cubierta = aP1_Cubierta;
         this.AV4REF_CGRAL_DESP_CARGA = aP2_REF_CGRAL_DESP_CARGA;
         this.AV5Resultado = 0 ;
         initialize();
         executePrivate();
      ...
      public short executeUdp( long aP0_Tonelaje ,
                               long aP1_Cubierta ,
                               String aP2_REF_CGRAL_DESP_CARGA )
      {
         this.AV2Tonelaje = aP0_Tonelaje;
      ...
      public void executeSubmit( long aP0_Tonelaje ,
                                 ...
                                 out short aP3_Resultado )
      {
         wscalcularrefcgraldesp objwscalcularrefcgraldesp;
         objwscalcularrefcgraldesp = new wscalcularrefcgraldesp();
         objwscalcularrefcgraldesp.AV2Tonelaje = aP0_Tonelaje;
         objwscalcularrefcgraldesp.AV3Cubierta = aP1_Cubierta;
         objwscalcularrefcgraldesp.AV4REF_CGRAL_DESP_CARGA = aP2_REF_CGRAL_DESP_CARGA;
         objwscalcularrefcgraldesp.AV5Resultado = 0 ;
         objwscalcularrefcgraldesp.context.SetSubmitInitialConfig(context);
         objwscalcularrefcgraldesp.initialize();
         ThreadPool.QueueUserWorkItem( new WaitCallback( executePrivateCatch ),objwscalcularrefcgraldesp);
         aP3_Resultado=this.AV5Resultado;
      }
      ...
      void executePrivateCatch( object stateInfo )
      {
         try
         {
            ((wscalcularrefcgraldesp)stateInfo).executePrivate();
         }
         catch ( Exception e )
         {
      ...
      void executePrivate( )
      {
         ...
         SoapParm.AssignLocationProperties( context, "Awscalcularrefcgraldesp", GXSoapHTTPClient);
         GXSoapHTTPClient.AddHeader("Content-type", "text/xml;charset=utf-8");
         GXSoapHTTPClient.AddHeader("SOAPAction", "CalcularPeajesaction/"+"AWSCALCULARREFCGRALDESP.Execute");
         ...
         GXSoapXMLWriter.WriteElement("Tonelaje", StringUtil.Trim( StringUtil.Str( (decimal)(AV2Tonelaje), 10, 0)));
         GXSoapXMLWriter.WriteAttribute("xmlns", "http://tempuri.org/");
         GXSoapXMLWriter.WriteElement("Cubierta", StringUtil.Trim( StringUtil.Str( (decimal)(AV3Cubierta), 10, 0)));
         GXSoapXMLWriter.WriteAttribute("xmlns", "http://tempuri.org/");
         GXSoapXMLWriter.WriteElement("Ref_cgral_desp_carga", StringUtil.RTrim( AV4REF_CGRAL_DESP_CARGA));
         GXSoapXMLWriter.WriteAttribute("xmlns", "http://tempuri.org/");
         GXSoapXMLWriter.WriteEndElement();
         GXSoapXMLWriter.WriteEndElement();
         GXSoapXMLWriter.WriteEndElement();
         GXSoapXMLWriter.Close();
         GXSoapHTTPClient.Execute("POST", "awscalcularrefcgraldesp.aspx");
         ...
         if ( GXSoapXMLReader.IsSimple == 0 )
         {
            ...
            else
            {
               ...
               while ( ( ( StringUtil.StrCmp(GXSoapXMLReader.Name, sTagName) != 0 ) || ( GXSoapXMLReader.NodeType == 1 ) ) && ( GXSoapError > 0 ) )
               {
                  ...
                  {
                     AV5Resultado = (short)(NumberUtil.Val( GXSoapXMLReader.Value, "."));
                     if ( GXSoapError > 0 )
                     {
                        readOk = 1;
                     }
         ...
         if ( currSoapErr != 0 )
         {
            oLocation = SoapParm.getlocation( context, "Awscalcularrefcgraldesp");
      ...
      private short AV5Resultado ;
      private short GXSoapError ;
      private short currSoapErr ;
      private short soapFault ;
      private short readOk ;
      private short nOutParmCount ;
      private long AV2Tonelaje ;
      private long AV3Cubierta ;
      ...
      private String AV4REF_CGRAL_DESP_CARGA ;
