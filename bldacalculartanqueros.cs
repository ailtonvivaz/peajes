...
using System.IO;
public class bldacalculartanqueros : GxBaseBuilder
{
   string cs_path = "." ;
   public bldacalculartanqueros( ) : base()
   {
   }
   ...
   {
      bldacalculartanqueros x = new bldacalculartanqueros() ;
      x.SetMainSourceFile( "acalculartanqueros.cs");
