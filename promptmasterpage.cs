/*
       ...
       Generated on: 1/26/2015 11:14:59.73
...
namespace GeneXus.Programs {
   public class promptmasterpage : GXMasterPage, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlCloseForm032( )
      {
         ...
         context.AddJavascriptSource("promptmasterpage.js", "?201512611145974");
      ...
      protected void wb_table6_24_032( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            context.WriteHtmlText( "<tbody>") ;
            context.WriteHtmlText( "<tr style=\"text-align:-khtml-left;text-align:-moz-left;text-align:-webkit-left\">") ;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?201512611145978");
            idxLst = (int)(idxLst+1);
         }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("promptmasterpage.js", "?201512611145978");
         }
