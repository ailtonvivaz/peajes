...
using System.IO;
public class bldsegmento1 : GxBaseBuilder
{
   string cs_path = "." ;
   public bldsegmento1( ) : base()
   {
   }
   ...
   {
      bldsegmento1 x = new bldsegmento1() ;
      x.SetMainSourceFile( "segmento1.cs");
   ...
   public override bool ToBuild( String obj )
   {
      ...
      if ( obj == @"bin\GeneXus.Programs.Common.dll" )
      {
         ...
         if (checkTime(obj, cs_path + @"\type_SdtContext.cs" ))
            return true;
         if (checkTime(obj, cs_path + @"\type_SdtOperTugSchedule.cs" ))
            return true;
         if (checkTime(obj, cs_path + @"\type_SdtOperTugSchedule_GetOperTugScheduleResult.cs" ))
            return true;
         if (checkTime(obj, cs_path + @"\type_SdtOperTugSchedule_GetOperTugScheduleResult_BOSUN1.cs" ))
            return true;
         if (checkTime(obj, cs_path + @"\type_SdtOperTugSchedule_GetOperTugScheduleResult_BOSUN2.cs" ))
            return true;
         if (checkTime(obj, cs_path + @"\type_SdtOperTugSchedule_GetOperTugScheduleResult_ENGINEER1.cs" ))
            return true;
         if (checkTime(obj, cs_path + @"\type_SdtOperTugSchedule_GetOperTugScheduleResult_ENGINEER2.cs" ))
            return true;
         if (checkTime(obj, cs_path + @"\type_SdtOperTugSchedule_GetOperTugScheduleResult_MASTER1.cs" ))
            return true;
         if (checkTime(obj, cs_path + @"\type_SdtOperTugSchedule_GetOperTugScheduleResult_MASTER2.cs" ))
            return true;
         if (checkTime(obj, cs_path + @"\type_SdtOperTugSchedule_GetOperTugScheduleResult_MATE1.cs" ))
            return true;
         if (checkTime(obj, cs_path + @"\type_SdtOperTugSchedule_GetOperTugScheduleResult_MATE2.cs" ))
            return true;
         if (checkTime(obj, cs_path + @"\type_SdtOperTugSchedule_GetOperTugScheduleResult_OILER1.cs" ))
            return true;
         if (checkTime(obj, cs_path + @"\type_SdtOperTugSchedule_GetOperTugScheduleResult_OILER2.cs" ))
            return true;
         if (checkTime(obj, cs_path + @"\type_SdtOperTugSchedule_GetOperTugScheduleResult_SEAMAN1.cs" ))
            return true;
         if (checkTime(obj, cs_path + @"\type_SdtOperTugSchedule_GetOperTugScheduleResult_SEAMAN2.cs" ))
            return true;
         if (checkTime(obj, cs_path + @"\type_SdtOperTugSchedule_GetOperTugScheduleResult_SEAMAN3.cs" ))
            return true;
         if (checkTime(obj, cs_path + @"\type_SdtOperTugSchedule_GetOperTugScheduleResult_SEAMAN4.cs" ))
            return true;
         ...
         if (checkTime(obj, cs_path + @"\GxModelInfoProvider.cs" ))
            return true;
         if (checkTime(obj, cs_path + @"\type_SdtProgressIndicator.cs" ))
            return true;
         if (checkTime(obj, cs_path + @"\type_Sdtwsrest_services.cs" ))
            return true;
         if (checkTime(obj, cs_path + @"\type_Sdtwscalcularportavehiculosroro_services.cs" ))
            return true;
