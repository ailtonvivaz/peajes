...
using System.IO;
public class bldawscalculartanqueros : GxBaseBuilder
{
   string cs_path = "." ;
   public bldawscalculartanqueros( ) : base()
   {
   }
   ...
   {
      bldawscalculartanqueros x = new bldawscalculartanqueros() ;
      x.SetMainSourceFile( "awscalculartanqueros.cs");
