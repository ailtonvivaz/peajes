/*
               File: WCCargaGeneral
        Description: WC para buques de carga general
             Author: GeneXus C# Generator version 10_3_2-86442
       Generated on: 1/26/2015 11:15:5.78
...
namespace GeneXus.Programs {
   public class wccargageneral : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wccargageneral( )
      {
      ...
      public wccargageneral( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20151261115579");
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" name=\"MAINFORM\" method=\"post\" class=\"form-horizontal Form\" novalidate action=\""+formatLink("wccargageneral.aspx") +"\">") ;
      ...
      {
         return formatLink("wccargageneral.aspx")  ;
      }

      public override String GetPgmname( )
      {
         return "wccargageneral" ;
      }

      public override String GetPgmdesc( )
      {
         return context.GetMessage( "WC para buques de carga general", "") ;
      }
      ...
      protected void WB1J0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Control Group */
            GxWebStd.gx_group_start( context, grpGroup1_Internalname, context.GetMessage( "Carga General", ""), 1, 0, "px", 0, "px", "Group", "", "HLP_WCCargaGeneral.htm");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-5 col-md-5", " "+"id"+" ");
            /* Div Control */
            ...
            wb_table1_24_1J2( true) ;
         }
         else
         {
            wb_table1_24_1J2( false) ;
         }
         return  ;
      }

      protected void wb_table1_24_1J2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</div>") ;
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", " "+"id"+" ");
            /* Control Group */
            GxWebStd.gx_group_start( context, grpGroup2_Internalname, context.GetMessage( "Resultados estimados en USD", ""), 1, 0, "px", 0, "px", "Group", "", "HLP_WCCargaGeneral.htm");
            /* Div Control */
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", " "+"id"+" ");
            wb_table2_39_1J2( true) ;
         }
         else
         {
            wb_table2_39_1J2( false) ;
         }
         return  ;
      }

      protected void wb_table2_39_1J2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</div>") ;
      ...
      protected void START1J2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", context.GetMessage( "WC para buques de carga general", ""), 0) ;
         }
         context.wjLoc = "";
      ...
      protected void E111J2( )
      {
         ...
         new calcularrefcgraldesp(context ).execute(  AV6Tonelaje,  AV7Cubierta,  context.GetMessage( "GENERAL", ""), out  GXt_SdtSdtResultado1) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV6Tonelaje", StringUtil.LTrim( StringUtil.Str( (decimal)(AV6Tonelaje), 10, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7Cubierta", StringUtil.LTrim( StringUtil.Str( (decimal)(AV7Cubierta), 10, 0)));
      ...
      protected void wb_table2_39_1J2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblResultadocargadotexto_Internalname, context.GetMessage( "Tránsito con carga:", ""), "", "", lblResultadocargadotexto_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WCCargaGeneral.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td id=\"\" class=\"\" >") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblResultadocargadocalculo_Internalname, lblResultadocargadocalculo_Caption, "", "", lblResultadocargadocalculo_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Estimados", 0, "", 1, 1, 0, "HLP_WCCargaGeneral.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td id=\"\" class=\"\" >") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblResultadolastretexto_Internalname, context.GetMessage( "Tránsito en lastre:", ""), "", "", lblResultadolastretexto_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_WCCargaGeneral.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td id=\"\" class=\"\" >") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblResultadolastrecalculo_Internalname, lblResultadolastrecalculo_Caption, "", "", lblResultadolastrecalculo_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Estimados", 0, "", 1, 1, 0, "HLP_WCCargaGeneral.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_39_1J2e( true) ;
         }
         else
         {
            wb_table2_39_1J2e( false) ;
         }
      }

      protected void wb_table1_24_1J2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttCalcular_Internalname, "", context.GetMessage( "Calcular", ""), bttCalcular_Jsonclick, 5, context.GetMessage( "Calcular", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'CALCULAR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WCCargaGeneral.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td id=\"\" class=\"\" >") ;
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 29,'',false,'',0)\"";
            ClassString = "BtnEnter";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttLimpiar_Internalname, "", context.GetMessage( "Limpiar", ""), bttLimpiar_Jsonclick, 7, context.GetMessage( "Limpiar", ""), "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e141j1_client"+"'", TempTags, "", 2, "HLP_WCCargaGeneral.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_24_1J2e( true) ;
         }
         else
         {
            wb_table1_24_1J2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2015126111560");
            idxLst = (int)(idxLst+1);
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wccargageneral.js", "?2015126111560");
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = context.GetMessage( "WC para buques de carga general", "");
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'LIMPIAR'","{handler:'E141J1',iparms:[],oparms:[{av:'AV6Tonelaje',fld:'vTONELAJE'},{av:'AV7Cubierta',fld:'vCUBIERTA'},{av:'lblResultadocargadocalculo_Caption',ctrl:'RESULTADOCARGADOCALCULO',prop:'Caption'},{av:'lblResultadolastrecalculo_Caption',ctrl:'RESULTADOLASTRECALCULO',prop:'Caption'}]}");
         setEventMetadata("'CALCULAR'","{handler:'E111J2',iparms:[{av:'AV6Tonelaje',fld:'vTONELAJE'},{av:'AV7Cubierta',fld:'vCUBIERTA'},{av:'AV5SdtResultado',fld:'vSDTRESULTADO'}],oparms:[{av:'AV5SdtResultado',fld:'vSDTRESULTADO'},{av:'lblResultadocargadocalculo_Caption',ctrl:'RESULTADOCARGADOCALCULO',prop:'Caption'},{av:'lblResultadolastrecalculo_Caption',ctrl:'RESULTADOLASTRECALCULO',prop:'Caption'}]}");
         return  ;
      }
