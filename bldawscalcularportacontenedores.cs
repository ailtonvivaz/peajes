...
using System.IO;
public class bldawscalcularportacontenedores : GxBaseBuilder
{
   string cs_path = "." ;
   public bldawscalcularportacontenedores( ) : base()
   {
   }
   ...
   {
      bldawscalcularportacontenedores x = new bldawscalcularportacontenedores() ;
      x.SetMainSourceFile( "awscalcularportacontenedores.cs");
