...
using System.IO;
public class bldawscalcularpasajeros : GxBaseBuilder
{
   string cs_path = "." ;
   public bldawscalcularpasajeros( ) : base()
   {
   }
   ...
   {
      bldawscalcularpasajeros x = new bldawscalcularpasajeros() ;
      x.SetMainSourceFile( "awscalcularpasajeros.cs");
